...
function Footer() {
    return (
        <div className='w-full h-screen bg-zinc-900 font-["Inter_Tight"] p-20 flex gap-5'>
            <div className='w-1/2 h-full flex-col justify-between'>
                <div className="heading">
                    <h1 className='text-[5vw] font-semibold uppercase leading-none tracking-tight '>Eye-</h1>
                    <h1 className='text-[5vw] font-semibold uppercase leading-none tracking-tight'>Opening</h1>
                </div>
                <div>
            ...
            <div className='w-1/2 h-full flex-col justify-between'>
                ...
                <h1 className='text-[5vw] font-semibold uppercase leading-none tracking-tight '>Presentations</h1>
